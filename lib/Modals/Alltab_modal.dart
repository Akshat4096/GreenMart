...
import 'package:fruit_application/components/Product_ontap.dart';

class Alltab_modal extends StatefulWidget {
  const Alltab_modal({super.key});


  @override
  State<Alltab_modal> createState() => _Alltab_modalState();
}

class _Alltab_modalState extends State<Alltab_modal> {
  @override
