...
class Edibles_modal extends StatefulWidget {
  const Edibles_modal({super.key});

  @override
  State<Edibles_modal> createState() => _Edibles_modalState();
}

class _Edibles_modalState extends State<Edibles_modal> {
  @override
